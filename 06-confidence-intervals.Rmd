...
• Methods based on mathematical theories can also be used to compute the standard error and confidence interval if the sampling distribution is normally distributed.  
\vspace{-0.1in}
```
