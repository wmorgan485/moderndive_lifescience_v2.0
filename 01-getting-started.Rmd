...
* ``... with `r (mammals %>% nrow() - 10) %>% comma()` more rows, and ... more variables:`` indicating to us that `r (mammals %>% nrow() - 10) %>% comma()` more rows of data and more variables that could not fit in this screen. (If you're screen is wide enough all `r mammals_cols` variables may fit and there will be no more variables to show.)
